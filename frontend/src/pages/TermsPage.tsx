...
export default function TermsPage() {
    return (
        <>
            <SEOHead title="Terms & Conditions" description="Read the terms and conditions for using NexusDigital services." canonical="/terms" />
            ...
            <section className="section-padding bg-white pt-8">
                <div className="container-custom max-w-3xl">
                    ...
                    <p className="text-dark-600 leading-relaxed mb-4">By accessing and using NexusDigital's website and services, you accept and agree to be bound by these Terms and Conditions.</p>
                    ...
                    <p className="text-dark-600 leading-relaxed mb-4">All content, designs, and materials created by NexusDigital remain our property until full payment is received, at which point ownership transfers to the client.</p>
                    <h2 className="font-heading text-2xl font-bold text-dark-900 mt-8 mb-4">5. Limitation of Liability</h2>
                    <p className="text-dark-600 leading-relaxed mb-4">NexusDigital shall not be liable for any indirect, incidental, or consequential damages arising from the use of our services.</p>
                    ...
                    <p className="text-dark-600 leading-relaxed">For questions about these terms, contact us at legal@nexusdigital.com.</p>
                </div>
            </section>
        </>
    );
